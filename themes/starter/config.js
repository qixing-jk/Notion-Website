...
const CONFIG = {
  ...
  STARTER_HERO_TITLE_1: 'NoTrans - Notion内容的多合一翻译器', // 英雄区文字
  ...
  STARTER_FEATURE_4_TITLE_1: '高度自定义化翻译', // 特性4
  STARTER_FEATURE_4_TEXT_1: '自由选择要翻译的内容块和属性，按需设置翻译规则', // 特性4
  STARTER_FEATURE_4_BUTTON_TEXT: '', // 特性4
  STARTER_FEATURE_4_BUTTON_URL: '', // 特性4

  // 首页ABOUT区块
  STARTER_ABOUT_ENABLE: true, // ABOUT区块开关
  STARTER_ABOUT_TITLE: 'NoTrans，让你的内容全球化',
  STARTER_ABOUT_TEXT:
  ...
  STARTER_FAQ_1_QUESTION: '是否支持复杂格式的翻译？',
  STARTER_FAQ_1_ANSWER:
    '是的，支持Notion中的所有块类型，包括页面内容和数据库属性，以及嵌套格式',

  STARTER_FAQ_2_QUESTION: '翻译内容是否保留原有格式？',
  ...
  STARTER_FAQ_4_ANSWER:
    '数据隐私安全是开发首要考虑，翻译内容绝不会泄露，完全保护用户隐私。',
  ...
  STARTER_TEAM_TEXT_2:
    '由<a className="underline" href="https://blog.qixing1217.top/about"> Qi Xing </a> 一人呕心沥血开发 <br> 持续打磨，功能不断升级，适应用户需求',
  ...
  STARTER_BLOG_TEXT_2:
    '这里会发布一些关于NoTrans 的最新动态，包括新的动向、新的未来计划，以及新功能的特性',
  ...
  STARTER_CONTACT_LOCATION_TEXT: '全球',
  STARTER_CONTACT_EMAIL_TITLE: '我们如何帮助您？',
  STARTER_CONTACT_EMAIL_TEXT: 'notionTranslator@qixing1217.top',
  ...
  STARTER_FOOTER_SLOGAN: '我们通过技术为品牌和公司创造更好的数字体验。',
