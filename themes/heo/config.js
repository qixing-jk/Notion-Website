const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2023-08-01', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    // { title: '欢迎来到我的博客', url: 'https://blog.qixing1217.top/' },
  ...
  HEO_HERO_TITLE_3: 'BLOG.QIXING1217.TOP',
  HEO_HERO_TITLE_4: '更多内容',
  HEO_HERO_TITLE_5: '更多小知识与有趣日常尽在七行的TG小仓库和博客',
  HEO_HERO_TITLE_LINK: 'https://t.me/storage_qi',
  HEO_HERO_TITLE_COVER: '',
  // 英雄区遮罩文字
  HEO_HERO_COVER_TITLE: '随便逛逛',

  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '必看精选', url: '/tag/推荐' },
  HEO_HERO_CATEGORY_2: { title: '疑难杂症', url: '/category/疑难杂症' },
  HEO_HERO_CATEGORY_3: { title: '实用教程', url: '/category/实用教程' },
