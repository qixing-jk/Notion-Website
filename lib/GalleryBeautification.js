...
export function GalleryBeautification(post) {
  ...
  if (isBrowser) {
    const observer = new MutationObserver(() => {
      ...
      const buttonList = document.getElementById('notion-article')?.querySelectorAll('.notion-collection-view-tabs-content-item')
...
function setHrefUrls(galleryViewColumnIndexDict) {
  ...
  observer.observe(document.getElementById('notion-article')?.querySelectorAll('.notion-collection-view-tabs-content-item')[0], {
    attributes: true,
    subtree: true
  })
}
