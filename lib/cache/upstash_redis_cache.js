...
export function isUpstashRedisRestApiUrl(url) {
  return url.includes('https://') && url.includes('upstash')
}
...
export async function setCache(key, data, customCacheTime) {
  try {
    await upstashRedisClient.set(key, JSON.stringify(data), {
      ex: customCacheTime || upstashRedisCacheTime
    })
  } catch (e) {
