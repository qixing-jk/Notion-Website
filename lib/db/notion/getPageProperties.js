...
import { isSHA256Digest, sha256Digest } from '@/lib/utils/password'
...
export default async function getPageProperties(
  ...
  if (fieldNames) {
    ...
    const needPropertiesSet = new Set(Object.values(fieldNames))
    for (const propertyKey of Object.keys(properties)) {
      if (!(propertyKey === 'id' || needPropertiesSet.has(propertyKey))) {
